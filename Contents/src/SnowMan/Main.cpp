...
namespace
{
    std::unique_ptr<Scene> g_sample;
};

LPCWSTR g_szAppName = L"SimpleTrianglePC";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    g_sample = std::make_unique<Scene>();
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"SimpleTrianglePCWindowClass";
        ...
        HWND hwnd = CreateWindowEx(0, L"SimpleTrianglePCWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    auto sample = reinterpret_cast<Scene*>(GetWindowLongPtr(hWnd, GWLP_USERDATA));
